...
class X12DocumentTestCase(unittest.TestCase):
    ...
    def _test_997(self, datakey):
        ...
        sift_pyx12.x12n_document.x12n_document(self.param, fd_source, fd_997, fd_html, None)
        fd_997.seek(0)
    ...
    def _test_999(self, datakey):
        ...
        hdlr = logging.NullHandler()
        logger.addHandler(hdlr)
        sift_pyx12.x12n_document.x12n_document(
...
class TestTemp(X12DocumentTestCase):
    ...
    def test_999_temp(self):
        ...
        sift_pyx12.x12n_document.x12n_document(param, fd_source, fd_997, fd_html, None)
        fd_997.seek(0)
        #self._isX12Diff(fd_997_base, fd_997)