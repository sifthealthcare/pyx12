...
from sift_pyx12.errors import X12PathError
...
class AbsPath(unittest.TestCase):
    ...
    def testLoopOK1(self):
        ...
        path = sift_pyx12.path.X12Path(path_str)
...
class RefDes(unittest.TestCase):
    def test_refdes(self):
        ...
        for (spath, seg_id, qual, eleidx, subeleidx) in tests:
            rd = sift_pyx12.path.X12Path(spath)
...
class RelativePath(unittest.TestCase):
    ...
    def test_bad_rel_paths(self):
        ...
        for spath in bad_paths:
            self.assertRaises(X12PathError, sift_pyx12.path.X12Path, spath)
...
class Equality(unittest.TestCase):
    def test_equal1(self):
        p1 = sift_pyx12.path.X12Path('/ISA_LOOP/GS_LOOP/ST_LOOP/DETAIL/2000A')
        p2 = sift_pyx12.path.X12Path('/ISA_LOOP/GS_LOOP/ST_LOOP/DETAIL/2000A')
    ...
    def test_equal2(self):
        p1 = sift_pyx12.path.X12Path('/ISA_LOOP/GS_LOOP/ST_LOOP/DETAIL/2000A')
        p2 = sift_pyx12.path.X12Path('/ISA_LOOP/GS_LOOP/ST_LOOP/DETAIL/')
    ...
    def test_equal3(self):
        p1 = sift_pyx12.path.X12Path('/AA/BB/CC/TST[1B5]03-1')
        p2 = sift_pyx12.path.X12Path('/AA/BB/CC/AAA[1B5]03-1')
        p2.seg_id = 'TST'
        self.assertEqual(p1, p2)
        self.assertEqual(p1.format(), p2.format())
        self.assertEqual(p1.__hash__(), p2.__hash__())
    ...
    def test_equal4(self):
        p1 = sift_pyx12.path.X12Path('1000B/TST03-2')
        p2 = sift_pyx12.path.X12Path('1000B/TST04-2')
        p2.ele_idx = 3
        self.assertEqual(p1, p2)
        self.assertEqual(p1.format(), p2.format())
        self.assertEqual(p1.__hash__(), p2.__hash__())
    ...
    def test_equal5(self):
        x12path = sift_pyx12.path.X12Path('/1000A/SD01')
...
class Empty(unittest.TestCase):
    def test_not_empty_1(self):
        p1 = '1000B/TST03-2'
        self.assertFalse(sift_pyx12.path.X12Path(
    ...
    def test_empty_1(self):
        p1 = ''
        a = sift_pyx12.path.X12Path(p1)
        self.assertTrue(sift_pyx12.path.X12Path(
...
class IsChild(unittest.TestCase):
    ...
    def testChildLoopOK1(self):
        path_str = '/ISA_LOOP/GS_LOOP/ST_LOOP/DETAIL/2000A/2000B/2300/2400'
        parent = sift_pyx12.path.X12Path(path_str)
