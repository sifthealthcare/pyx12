...
class ReadConfigFile(unittest.TestCase):
    def setUp(self):
        ...
        #self.param = sift_pyx12.params.params(os.path.join(test_path, 'sift_pyx12test.conf.xml'))
    ...
    def notest_invalid_file(self):
        self.assertRaises(sift_pyx12.errors.EngineError, sift_pyx12.params.params, 'nonexistant_file.xml')
