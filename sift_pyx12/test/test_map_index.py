...
class GetFilename(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.idx = sift_pyx12.map_index.map_index()
...
class GetFilenameMapPath(unittest.TestCase):
    ...
    def setUp(self):
        import os.path
        map_path = os.path.join(os.path.dirname(sift_pyx12.map_index.__file__), 'map')
        param = sift_pyx12.params.params()
        self.idx = sift_pyx12.map_index.map_index(map_path)
