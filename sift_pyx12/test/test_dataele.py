...
class LookupDataElemMapPath(unittest.TestCase):
    ...
    def setUp(self):
        import os.path
        map_path = os.path.join(os.path.dirname(sift_pyx12.dataele.__file__), 'map')
        self.de = sift_pyx12.dataele.DataElements(map_path)
