...
class ArbitraryDelimiters(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.seg = sift_pyx12.segment.Segment(self.seg_str, '+', '&', '!')
...
class Identity(unittest.TestCase):
    ...
    def test_identity1(self):
        ...
        seg = sift_pyx12.segment.Segment(seg_str, '~', '*', ':')
...
class Composite(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.seg = sift_pyx12.segment.Segment(seg_str, '~', '*', ':')
...
class IsEmpty(unittest.TestCase):
    ...
    def test_empty_comp1(self):
        comp_str = ''
        comp = sift_pyx12.segment.Composite(comp_str, ':')
...
class Equality(unittest.TestCase):
    ...
    def test_equal1(self):
        seg1 = sift_pyx12.segment.Segment('TST*AA*1*Y*BB:5*ZZ', '~', '*', ':')
        seg2 = sift_pyx12.segment.Segment('TST*AA*1*Y*BB:5*ZZ', '~', '*', ':')
        self.assertEqual(seg1, seg2)

    def test_not_equal1(self):
        seg1 = sift_pyx12.segment.Segment('TST*AA*1*Y*BB:5*ZZ', '~', '*', ':')
        seg2 = sift_pyx12.segment.Segment('TTT*AA*1*Y*BB:5*ZZ', '~', '*', ':')
        self.assertNotEqual(seg1, seg2)

    def test_not_equal2(self):
        seg1 = sift_pyx12.segment.Segment('TST*AA*1*Y*BB:5*ZZ', '~', '*', ':')
        seg2 = sift_pyx12.segment.Segment('TST*AA*1*Y*BB:5', '~', '*', ':')
        self.assertNotEqual(seg1, seg2)

    def test_not_equal3(self):
        seg1 = sift_pyx12.segment.Segment('TST*AA*1*Y*BB:5*ZZ', '~', '*', ':')
        seg2 = sift_pyx12.segment.Segment('TST*AA*1*Y*BB:4*ZZ', '~', '*', ':')
        self.assertNotEqual(seg1, seg2)
...
class IsaTerminators(unittest.TestCase):
    ...
    def test_no_change_4010(self):
        ...
        result = initial
        seg_isa = sift_pyx12.segment.Segment(initial, '~', '*', ':')
