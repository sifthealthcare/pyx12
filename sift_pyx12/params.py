...
class ParamsBase(object):
    ...
    """
    def __init__(self):
        self.logger = logging.getLogger('sift_pyx12.params')
        self.params = {}
        ...
        if not isdir(map_path):
            map_path = join(sys.prefix, 'share', 'sift_pyx12', 'map')
...
class ParamsUnix(ParamsBase):
    ...
    def __init__(self, config_file=None):
        ...
        config_files = [join(sys.prefix, 'etc/sift_pyx12.conf.xml'),
                        expanduser('~/.sift_pyx12.conf.xml')]
