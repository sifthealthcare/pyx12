...
from sift_pyx12.rawx12file import RawX12File
    ...
    def _parse_segment(self, seg_data):
        ...
        if seg_id == 'ISA':
            if len(seg_data) != 16:
                ...
                raise sift_pyx12.errors.X12Error(err_str)
        ...
        #    del self.loops[-1]
            ...
            if self.hl_count != self._int(hl_count):
                #raise sift_pyx12.errors.X12Error, \
...
class X12Reader(X12Base):
    ...
    def __iter__(self):
        ...
        for line in self.raw:
            ...
            seg_data = sift_pyx12.segment.Segment(line, self.seg_term, self.ele_term, self.subele_term)
...
class X12Writer(X12Base):
    ...
    def _get_trailer_segment(self, seg_id, count, id):
        ...
        return sift_pyx12.segment.Segment(seg_str, self.seg_term, self.ele_term,
                                     self.subele_term)
