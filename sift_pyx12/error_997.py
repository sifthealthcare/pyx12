...
logger = logging.getLogger('sift_pyx12.error_997')
...
class error_997_visitor(error_visitor.error_visitor):
    ...
    def visit_root_post(self, errh):
        ...
        @type errh: L{error_handler.err_handler}
        """
        self._write(sift_pyx12.segment.Segment('GE*%i*%s' % (self.st_loop_count,
        ...
        self._write(sift_pyx12.segment.Segment('IEA*%i*%s' %
    ...
    def visit_gs_pre(self, err_gs):
        ...
        #self._write(seg)
        self._write(sift_pyx12.segment.Segment('ST*997*%04i' %
                                          (self.st_control_num), '~', '*', ':'))
        self.seg_count = 0
        self.seg_count = 1
        ...
        #self._write(seg)
        self._write(sift_pyx12.segment.Segment('AK1*%s*%s' %
...
#        self.ack_code = None # AK501
        seg_data = sift_pyx12.segment.Segment('AK5', '~', '*', ':')
#        self.err_cde = [] # AK502-6
    ...
    def visit_seg(self, err_seg):
        ...
        seg_base = sift_pyx12.segment.Segment('AK3', '~', '*', ':')
    ...
    def visit_ele(self, err_ele):
        ...
        seg_base = sift_pyx12.segment.Segment('AK4', '~', '*', ':')
